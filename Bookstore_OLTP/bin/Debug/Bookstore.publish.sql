/*
Script de implementación para BikeStores_OLTP
...
GO
:setvar DatabaseName "BikeStores_OLTP"
:setvar DefaultFilePrefix "BikeStores_OLTP"
...
GO
PRINT N'Modificando Procedimiento [dbo].[GetDatabaseRowVersion]...';


GO
ALTER PROCEDURE [dbo].[GetDatabaseRowVersion]
AS
BEGIN
